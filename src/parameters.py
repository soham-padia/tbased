...
NODE_COMPUTING_CAPACITY = 10        # Computing capacity per node (arbitrary unit)
MAX_TRANSACTION_THROUGHPUT = 50     # Maximum expected transaction throughput
MAX_COMPUTATION_COST = NODE_COMPUTING_CAPACITY * TOTAL_NODES  # Maximum computation cost
